<x-app-layout>
    <div class="mt-6 max-w-sm mx-auto">
        <form method="POST" action="{{ route('employee.update', $employee->id) }}"
            ...
            @csrf
            @method('patch')
            <h1 class="text-white flex justify-center"> Update Employee</h2>
            <!-- Employee Id -->
            <div class="mt-4">
                ...
                <x-text-input id="employee_company_id" class="block mt-1 w-full" type="text" name="employee_company_id" :value="old('employee_company_id')"
                    required autofocus value="{{$employee->employee_company_id}}" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="fname" class="block mt-1 w-full" type="text" name="fname" :value="old('fname')"
                        required autofocus value="{{$employee->fname}}" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="lname" class="block mt-1 w-full" type="text" name="lname"
                        :value="old('lname')" required autofocus value="{{$employee->lname}}" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="email" class="block mt-1 w-full" type="email" name="email"
                        :value="old('email')" required value="{{$employee->email}}" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="number" class="block mt-1 w-full" type="text" name="number" :value="old('number')"
                        required autofocus value="{{$employee->number}}" />
